  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center gap-4 mb-6">
        <Link to="/cve" className="text-gray-400 hover:text-gray-600">
          ← CVE Monitor
        </Link>
        <div>
          <h1 className="text-2xl font-bold text-gray-900">CVE Browser</h1>
      ...
      >
        ...
        <div className="flex flex-wrap gap-3 items-end">
          ...
          <div>
            <label className="block text-xs text-gray-500 mb-1">Min CVSS</label>
            <input
              type="number"
              min={0}
              max={10}
          ...
          <div>
            <label className="block text-xs text-gray-500 mb-1">Published from</label>
            <input
              type="date"
              value={from}
      ...
      {/* Error */}
      {error && (
        <div className="text-sm text-red-600 bg-red-50 rounded-xl p-4 mb-4">{error}</div>
      )}
        ...
        <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 border-b border-gray-100">
              <tr>
                <th className="text-left px-4 py-2.5 text-xs font-medium text-gray-500">CVE ID</th>
                <th className="text-left px-4 py-2.5 text-xs font-medium text-gray-500">Severity</th>
                <th className="text-right px-4 py-2.5 text-xs font-medium text-gray-500">CVSS</th>
                <th className="text-left px-4 py-2.5 text-xs font-medium text-gray-500">Published</th>
                <th className="text-left px-4 py-2.5 text-xs font-medium text-gray-500 max-w-sm">Description</th>
              </tr>
            </thead>
